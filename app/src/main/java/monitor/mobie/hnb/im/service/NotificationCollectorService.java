package monitor.mobie.hnb.im.service;
...
//        SharedPreferences data = PreferenceManager.getDefaultSharedPreferences(this);
        ...
        //用户ID
        String PUSHURL_ID = data.getString("PUSHURL_ID", "");
        //用户Key
        String PUSHURL_KEY = data.getString("PUSHURL_KEY", "");
        //PUSHURL
        ...
        //是否打开URL推送
        boolean PUSHURL_enable = data.getBoolean("PUSHURL_enable", true);		
...
//            屏幕亮屏的情况下不发送任何信息.
        ...
        try {
            ...
            //进行URL推送
            if (!PUSHURL_ID.isEmpty() && !PUSHURL_KEY.isEmpty() && !PUSHURL.isEmpty() && PUSHURL_enable) {
                sendServerUrl(sbn, listenAll, PUSHURL, PUSHURL_ID, PUSHURL_KEY);
            }			
